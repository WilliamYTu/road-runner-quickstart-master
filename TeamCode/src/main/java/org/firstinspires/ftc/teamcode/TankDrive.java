...
public final class TankDrive {
    public static class Params {
        ...
        public double inPerTick = 0.0223880597014925;
        public double trackWidthTicks = 690.6032754567979;

        // feedforward parameters (in tick units)
        public double kS = 2.7625586601804386;
        public double kV = 0.004345804423564203;
        public double kA = 0.006;
    ...
    public TankDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftMotors = Arrays.asList(hardwareMap.get(DcMotorEx.class, "leftFront"));
        rightMotors = Arrays.asList(hardwareMap.get(DcMotorEx.class, "rightFront"));
